...
<div class="navbar navbar-inverse">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">Home</a> <!--Instead of home, letak nama clinic tu sbb pakai 'brand'-->
    </div>
    <div class="navbar-collapse collapse navbar-inverse-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="bootstrap-elements.php" data-target="#" class="dropdown-toggle" data-toggle="dropdown">UTP Clinic Services
            <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="#">Appointment</a></li>
            <li><a href="#">MC Alert</a></li>
            <li class="divider"></li>
            <li class="dropdown-header">Other Services</li>
            <li><a href="#">See and Act</a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="bootstrap-elements.php" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Account Settings
            <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="javascript:void(0)">Log In</a></li>
            <li><a class="dropdown-item" href="javascript:void(0)">Log Out</a></li>
            <li><a class="dropdown-item" href="javascript:void(0)">My Profile</a></li>
            <li class="divider"></li>
            <li><a href="javascript:void(0)">Password Recovery</a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<!--Healthy tips Starts Here-->
	...
	<!--         carousel  -->
	    <div class="section" id="carousel">
			<div class="container">
				<div class="row">
                    <h2 class='text-center'>Our Latest Events</h2>
